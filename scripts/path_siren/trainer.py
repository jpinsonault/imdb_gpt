...
from scripts.autoencoder.ae_loader import AutoencoderLoadError, _load_frozen_autoencoders
...
class PathSirenTrainer:
    def __init__(self, config: ProjectConfig):
        ...
        try:
            # Uses the joint AEs as wired in ae_loader; returns movie + person AEs.
    ...
    def _first_person_losses(
        ...
        # decode back to person fields at first step
        preds = []
        for dec in self.per_ae.decoder.decs:
    ...
    def train(self):
        ...
        for epoch in range(epochs):
            ...
            for Mx, My, Zt, Z_lat_tgts, Yp_tgts, t_grid, time_mask in pbar:
                ...
                # aggregated title loss (for logging)
                loss_title = (
