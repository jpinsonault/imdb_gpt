...
def kermit_language_model(input_length, alphabet_size, character_embedding_dim, num_blocks=4):
    ...
    most_recent_token = x[:, -1, :]
    x *= Reshape((1, character_embedding_dim))(most_recent_token)
    ...
    for i in range(num_blocks):
        ...
        most_recent_token_transformed = Reshape((1, character_embedding_dim))(most_recent_token)
        x = Multiply(name=n("merge_most_recent_token"))([x, most_recent_token_transformed])
    ...
    for i in range(num_reductions):
        ...
        most_recent_projection = Reshape((1, character_embedding_dim))(most_recent_projection)
